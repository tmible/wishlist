 ...
 * и имён пользователей -- участников кооперации или забронировавшего пользователя на массивы
 ...
 * } listItem Элемент списка с участниками в виде строк
 * @returns {
 *   {
 *     participants: string[];
 *     participantsIds: number[];
 *   } & Record<string, unknown>
 * } Элемент списка с участниками в виде массивов
 */
