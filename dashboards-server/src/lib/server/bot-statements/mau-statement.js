 ...
 * SQL выражения для получения из БД с логами метрики MAU бота для каждого дня указанного периода
 * @function initBotMAUStatement
 * @returns {void}
 */
export const initBotMAUStatement = () => provide(
  InjectionToken.BotMAUStatement,
