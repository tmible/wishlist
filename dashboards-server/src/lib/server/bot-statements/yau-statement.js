 ...
 * SQL выражения для получения из БД с логами метрики YAU бота для каждого дня указанного периода
 * @function initBotYAUStatement
 * @returns {void}
 */
export const initBotYAUStatement = () => provide(
  InjectionToken.BotYAUStatement,
