 ...
 * SQL выражения для получения из БД с логами метрики DAU бота для каждого дня указанного периода
 * @function initBotDAUStatement
 * @returns {void}
 */
export const initBotDAUStatement = () => provide(
  InjectionToken.BotDAUStatement,
